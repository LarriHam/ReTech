...
<div class="px-4 py-4">
    <h3 class="text-2xl font-extrabold dark:text-white">Edit Product</h3>

    <form enctype="multipart/form-data" action="{{route('admin.products.update', $product->id)}}" method="post">
        @csrf
        @method('PUT')

        <img width="150" class="mb-4" src="{{ asset("storage/images/" . $product->img) }}" alt="Current Image">

        <input type="file" name="img" placeholder="image" class="w-full mt-6" field="img"/>
        ...
        <div>
            ...
            <input type="text" name="rating" id="rating" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ old('rating') ? : $product->rating }}"/>
